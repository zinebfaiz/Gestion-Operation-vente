...
<head>
    ...
    <script>
 		...
 		// Met à jour la liste des articles selon la catégorie choisie
        function updateArticles() {
         ...
         // Si la catégorie existe dans articlesData, on charge ses articles
     ...
     // Ajoute un champ caché pour stocker les données à envoyer au serveur
     ...
     // Ajoute une ligne au tableau de commande avec les infos saisies
    ...
    <%
 		...
 		// Connexion à la base Oracle pour charger les articles
        ...
        try {
         ...
         // Organisation des articles par catégorie dans une Map
         ...
         // Conversion en JavaScript (variable articlesData)
        	...
        	// ⚠Gestion d’erreur si problème de connexion ou de requête
...
<body>
    ...
    <form action="interface2.jsp" method="post">
        ...
        <select id="categorie" onchange="updateArticles()">
            ...
            <%	
         		// Chargement des catégories d’articles
                try {
                    conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521/orcl", "zineb", "zineb123");
                    stmt = conn.createStatement();
		...
		<!-- Tableau récapitulatif des articles ajoutés -->
	...
	<!-- Vérifie les champs cachés avant l’envoi -->
    <script>
    ...
    <%
 // Enregistre les données dans la session pour la page suivante
